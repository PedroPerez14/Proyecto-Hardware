...
void timer2_inicializar(void)
{
	...
	rINTMOD |= 0x800; // Configura la línea del timer2 como IRQ
...
void timer2_empezar(void)
{
	...
	rTCMPB2 = COMP_VALUE;// valor de comparación
...
unsigned int timer2_leer(void)
{
	...
	//Si queremos optimizar, como la multiplicación es por 2048, se pueden mover los bits 16 lugares a al izquierda y en la división, al ser por 32, se pueden mover 5 a la derecha.
}
