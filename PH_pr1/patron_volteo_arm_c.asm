...
patron_volteo_arm_arm:
				...
				@ r0=@ de la posicion en el tablero a analizar  @Cambiar como el ejemplo de abajo
				add r0, r0, r2, LSL #DESPL
				add r0, r0, r3
...
WHILE_ASM:		add r2, r2, r4
				...
				add r0, r0, r4, LSL #DESPL @añadir fila
				add r0, r0, r5	@añadir columna
				...
				ldrb r7, [r0]	@ r7=tablero[FA][CA]
				cmp r7, #CASILLA_VACIA
				beq FIN_ASM		@r7=CASILLA_VACIA
				
				
				@ En este punto la posición es válida
				cmp r7, r6
				beq FIN_VALIDA_ASM		@ tablero[FA][CA] == color
				@ sumar 1 a longitud
				add r8, r8, #1
				b WHILE_ASM
				
FIN_VALIDA_ASM: cmp r8, #0
				movne r9, #PATRON_ENCONTRADO
				
FIN_ASM:		str r8, [r1]	@ Almacenar longitud calculada
