...
// Declaración patron_volteo_arm_c
...
////////////////////////////////////////////////////////////////////////////////
// Función para depurar las diferentes implementaciones de patrón volteo
int patron_volteo_test(char tablero[][DIM], int *longitud, char FA, char CA, char SF, char SC, char color)
{
	int patron, patron_arm_c, patron_arm_arm;
	...
	if (patron != patron_arm_c || patron != patron_arm_arm) {
		while (1);
	}
	return patron;
}
